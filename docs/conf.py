...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            '-o',
            str(DOCS / 'API'),
            os.path.join(DOCS / '..' / 'src' / 'pypkgla01'),
        ]
    )
...
source_suffix = '.rst'
master_doc = 'index'
project = 'PyPkg Local Local Artifacts 01'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = pypkgla01.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz-testing/pypkgla01/issues/%s', '#'),
    'pr': ('https://github.com/goerz-testing/pypkgla01/pull/%s', 'PR #'),
}
