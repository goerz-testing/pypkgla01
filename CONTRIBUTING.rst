...
Everyone interacting in the PyPkg Local Local Artifacts 01 project's code base,
...
Report bugs at https://github.com/goerz-testing/pypkgla01/issues.
...
The best way to send feedback is to file an issue at https://github.com/goerz-testing/pypkgla01/issues.
...
3. Check https://travis-ci.org/goerz-testing/pypkgla01/pull_requests
...
Ready to contribute? Follow `Aaron Meurer's Git Workflow Notes`_ (with ``goerz-testing/pypkgla01`` instead of ``sympy/sympy``)

In short,

1. Clone the repository from ``git@github.com:goerz-testing/pypkgla01.git``
...
PyPkg Local Local Artifacts 01 uses a simple branching model where all
...
PyPkg Local Local Artifacts 01 includes a full test-suite using pytest_.
We strive for a `test coverage`_ above 90%.


From a checkout of the ``pypkgla01`` repository  you can use
...
.. _test coverage: https://coveralls.io/github/goerz-testing/pypkgla01?branch=master
...
PyPkg Local Local Artifacts 01 could always use more documentation, whether
...
At any point, from a checkout of the ``pypkgla01``
...
:mod:`pypkgla01` package:

.. doctest::

    >>> import pypkgla01
    >>> pypkgla01.__version__   # doctest: +SKIP
...
https://github.com/goerz-testing/pypkgla01/releases.
